...
import com.modelviewer.IndexedModel;
import com.modelviewer.Light;
import com.modelviewer.util.Util;

import static com.modelviewer.util.Util.readIntLe;
...
public class XYZModel extends IndexedModel {

    private final float[] pointColor = new float[] { 1.0f, 1.0f, 1.0f };

    public XYZModel(@NonNull InputStream inputStream) throws IOException {
        super();
